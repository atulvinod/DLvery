...
public class agentQueries implements Serializable {
    ...
    public static List<agent_details> getAllAgentDetails() throws SQLException {
    ...
    public static List<agent_details> getAgentDetail(String id) throws SQLException {
        List<agent_details> list = new LinkedList<>();
        Connection connection = dataSource.getConnection();
    ...
    public static List<pending_for_agent> getOutForDeliveryForAgent(String agent_id) throws SQLException {
        List<pending_for_agent> list = new LinkedList<>();
        Connection connection = dataSource.getConnection();
    ...
    public static List<pending_for_agent> getExpectedDeliveryTodayForAgent(String agent_id) throws SQLException {
        List<pending_for_agent> list = new LinkedList<>();
        Connection connection = dataSource.getConnection();
    ...
    public static List<pending_for_agent> getMissedDeliveryForAgent(String agent_id) throws SQLException {
        List<pending_for_agent> list = new LinkedList<>();
        Connection connection = dataSource.getConnection();

        PreparedStatement statement = connection.prepareStatement("SELECT dt.inventory_id, dt.delivery_id,delivery_assigned_date, agent_id,status,reciever_name,delivery_date,sku,name,move_in_date,move_out_date,perishable,expiry,delivery_address,delivery_status,delivery_to_name,delivery_from,delivery_to_contact FROM delivery_table dt INNER JOIN inventory_table it ON dt.inventory_id = it.inventory_id WHERE dt.agent_id = ? AND (dt.status = \"PENDING\" OR dt.status = \"DOOR_LOCK\" ) AND DATE(move_out_date) < DATE(NOW()) ORDER BY ABS(DATEDIFF(move_out_date, NOW())) DESC;", ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
        statement.setString(1, agent_id);
        ResultSet x = statement.executeQuery();
        while (x.next()) {
    ...
    public static List<pending_for_agent> getUpcomingDeliveryForAgent(String agent_id) throws SQLException {
        List<pending_for_agent> list = new LinkedList<>();
        Connection connection = dataSource.getConnection();

        PreparedStatement statement = connection.prepareStatement("SELECT dt.inventory_id, dt.delivery_id,delivery_assigned_date, agent_id,status,reciever_name,delivery_date,sku,name,move_in_date,move_out_date,perishable,expiry,delivery_address,delivery_status,delivery_to_name,delivery_from,delivery_to_contact FROM delivery_table dt INNER JOIN inventory_table it ON dt.inventory_id = it.inventory_id WHERE dt.agent_id = ? AND (dt.status = \"PENDING\" OR dt.status = \"DOOR_LOCK\" ) AND DATE(move_out_date) > DATE(NOW()) ORDER BY ABS(DATEDIFF(move_out_date, NOW()));", ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
        statement.setString(1, agent_id);
        ResultSet x = statement.executeQuery();
        while (x.next()) {
    ...
    public static List<delivery_table> getDeliveredForAgent(String agent_id) throws SQLException {
    ...
    public static void setOutForDelivery(String delivery_id) throws SQLException {
        Connection connection = dataSource.getConnection();
    ...
    public static void setDoorLocked(String delivery_id) throws SQLException {
        Connection connection = dataSource.getConnection();
    ...
    public static void setReturned(String delivery_id) throws SQLException {
        Connection connection = dataSource.getConnection();
    ...
    public static void setTransitDamaged(String delivery_id) throws SQLException {
        Connection connection = dataSource.getConnection();
        DateTimeFormatter dtf = DateTimeFormatter.ofPattern("yyyy-MM-dd");
