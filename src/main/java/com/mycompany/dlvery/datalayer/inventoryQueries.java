...
public class inventoryQueries implements Serializable {
    ...
    public static List<delivery_details> getAllDeliveryDetails() {
    ...
    public static List<delivery_details> getAllDeliveredDetails() {
        List<delivery_details> inventory = new LinkedList<delivery_details>();
        try (Connection connection = dataSource.getConnection()) {
    ...
    public static List<delivery_details> getAllDeliveredDetailsBetweenDates(String fromDate, String toDate) {
        List<delivery_details> inventory = new LinkedList<delivery_details>();
        try (Connection connection = dataSource.getConnection()) {
    ...
    public static List<assigned_delivery> getAssignedAndDeliveredInventoryStatus() {
        List<assigned_delivery> list = new LinkedList<>();
        try (Connection connection = dataSource.getConnection()) {
            PreparedStatement statement = connection.prepareStatement("SELECT dt.delivery_id,it.inventory_id,ad.agent_id,status,reciever_name,reciever_signature,delivery_date,agent_name,agent_email,agent_auth_id,auth_status,sku,name,move_in_date,move_out_date,perishable,expiry,delivery_address,delivery_to_name FROM delivery_table dt INNER JOIN agent_details ad ON dt.agent_id = ad.agent_id INNER JOIN inventory_table as it  ON it.inventory_id = dt.inventory_id WHERE dt.status = \"DELIVERED\";", ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
            ResultSet res = statement.executeQuery();
    ...
    public static List<assigned_delivery> getAssignedAndTransitDamagedInventoryStatus() {
        List<assigned_delivery> list = new LinkedList<>();
        try (Connection connection = dataSource.getConnection()) {
    ...
    public static List<assigned_delivery> getAssignedAndDeliveredInventoryStatusBetweenDates(String from, String to) {
        List<assigned_delivery> list = new LinkedList<>();
        try (Connection connection = dataSource.getConnection()) {
            DateTimeFormatter dtf = DateTimeFormatter.ofPattern("yyyy-MM-dd");
    ...
    public static List<inventory_table> getAllInventoryAccToCategory(String cat) {
    ...
    public static List<inventory_table> getAccToCategoryAndPerishableStatus(String cat, boolean perishable) {
        List<inventory_table> list = new LinkedList<>();
        try (Connection connection = dataSource.getConnection()) {
    ...
    public static List<inventory_table> getAccToCategoryAndDamagedStatus(String cat, boolean damaged) {
        List<inventory_table> list = new LinkedList<>();
        try (Connection connection = dataSource.getConnection()) {
    ...
    public static List<inventory_table> getAccToCategoryAndNearExpiry(String cat) {
        List<inventory_table> list = new LinkedList<>();
        try (Connection connection = dataSource.getConnection()) {
    ...
    public static List<delivery_table> getDeliveryBetweenDates(Date from, Date to) {
    ...
    public static void setOutForDelivery(String id) {
        try (Connection connection = dataSource.getConnection()) {
