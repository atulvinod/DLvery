...
public class getSignatureImage extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (Connection connection = connectionPool.getDataSource().getConnection()) {
            PreparedStatement statement = connection.prepareStatement("SELECT reciever_signature FROM delivery_table WHERE delivery_id = ?");
            statement.setString(1, delivery_id);
            ResultSet result = statement.executeQuery();
            result.next();
            Blob imageBlob = result.getBlob("reciever_signature");
            ...
            response.getOutputStream().print(base64Image);
