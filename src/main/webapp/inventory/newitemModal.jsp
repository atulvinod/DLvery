...
<html>
                    ...
                    <div class="modal-body">
                        ...
                        <form  id="newInventoryItemForm">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox"  id="perishable"  name="perishable">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox"  id="damaged" name="damaged" >
    ...
    <!-- <script src="../javascript/dashboard.js" type="text/javascript" defer="true"/> -->
    <!-- <script>
